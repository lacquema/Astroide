...
c Authors:  H. Beust
c Date:    06/08/2007
c Rm: adapted from swift_symba5.f 
...
c***************here's the big loop *************************************
      ...
      do while ( (t .le. tstop) .and. (nbod.gt.1) )
         ...
         call symba5_step_pl_lyap(diro,fopenstat,i1st,t,nbod,nbodm,
     &        mass,j2rp2,j4rp4,xh,yh,zh,vxh,vyh,vzh,dt,lclose,
     &        rpl,isenc,mergelst,mergecnt,iecnt,eoff,rhill,mtiny)
...
c**************************************************
            print*,'t=',t,'nbod=',nbod,'nbodm=',nbodm
