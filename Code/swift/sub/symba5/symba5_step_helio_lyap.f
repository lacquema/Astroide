...
c                                       (real arrays)
c Remarks: Copy of symba5_step_helio.f because of saved vels.
c         
c Authors:  H Beust
c Date:    6/8/2007

      subroutine symba5_step_helio_lyap(i1st,nbod,nbodm,mass,j2rp2,
...
c...  Get the accelerations in helio frame. if frist time step
      call symba5_helio_getacch(i1stloc,nbod,nbodm,mass,j2rp2,j4rp4,
