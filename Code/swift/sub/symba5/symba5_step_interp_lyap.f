...
c                 eoff          ==>  Energy offset (real scalar)
c Remarks: Copy of symba5_step_interp.f because of saved accels
c Authors:  Hal Levison 
c Date:    11/21/96
c Last revision: 5/13/99

      subroutine symba5_step_interp_lyap(time,iecnt,ielev,nbod,
