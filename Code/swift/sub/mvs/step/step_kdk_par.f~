...
c
      ...
      subroutine step_kdk_mig(i1st,time,nbod,ntp,mass,j2rp2,j4rp4,
     &     xh,yh,zh,vxh,vyh,vzh,xht,yht,zht,vxht,vyht,vzht,
     &     istat,rstat,dt,Envartot,Hvartot)	
...
c...  first do the planets
      call step_kdk_mig_pl(i1st,nbod,mass,j2rp2,j4rp4,
     &     xh,yh,zh,vxh,vyh,vzh,dt,-Envartot,-Hvartot)
