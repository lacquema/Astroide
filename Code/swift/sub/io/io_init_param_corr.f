c************************************************************************
c                          IO_INIT_PARAM_CORR.F
c************************************************************************
c INIT_PARAM reads in the parameters for the integration. 
c   CORR : Gets order of symplectic correction
c      Input:
...
c Last revision: 
        ...
        subroutine io_init_param_corr(infile,t0,tstop,dt,dtout,dtdump,
     &         iflgchk,nsta,rmin,rmax,rmaxu,qmin,lclose,diro,dirs,gname,
     &         outfile,fopenstat)
...
c        write(*,*)outfile
        ...
        write(*,*) '# of correction stages (1,2,4,6,10)'
        read(7,*) nsta
