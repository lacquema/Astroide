...
c
c             Input:
c                 oname        ==> string with the full path (character*(chlen))
c   
c             Output:
c                 dirname     ==> string with the path (character*(chlen))
c                 ldir        ==> length of dirname (integer scalar)
c                 filename     ==> string with the file name (character*(chlen))
...
c...  Inputs: 
      character*(chlen) oname

c...  Outputs:
      integer ldir,lfile
      character*(chlen) dirname,filename
