...
c Date:    Sep 27, 2006
	...
	subroutine io_dump_pl_hjs_tmrp(dplfile,nbod,oloc,coef,
     &        mass,umat,xj,yj,zj,vxj,vyj,vzj,lclose,iflgchk,rplsq)
...
c...    Input
	...
	real*8 mass(nbod),rplsq(nbod),coef(nbod)
