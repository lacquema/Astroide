...
class WindowMenuClass(QMainWindow):
    ...
    def __init__(self):
        ...
        self.BtnNew.setStyleSheet('QPushButton{background-color: grey; color: lightgrey; font: bold italic 15px;}')
        ...
        self.BtnContinue.setStyleSheet('QPushButton{background-color: grey; color: lightgrey; font: bold italic 15px}')
        ...
        self.BtnAnalyse.setStyleSheet('QPushButton{background-color: grey; color: lightgrey; font: bold italic 15px;}')
