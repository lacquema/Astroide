...
c Last revision: 1/20/97
         ...
         subroutine discard_peri_new(time,ntp,xht,yht,zht,vxht,vyht,
     &    vzht,qmin,istat,rstat,nbod,mass,xh,yh,zh,vxh,vyh,vzh,outfile)
...
c...  Executable code 
     ...
     &     mass(1),isperi,peri,lperi)
      ...
      open(806,FILE=outfile,POSITION="APPEND")
