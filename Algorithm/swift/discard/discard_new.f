...
c Last revision: 1/20/97
      ...
      subroutine discard_new(time,dt,nbod,ntp,mass,xh,yh,zh,vxh,
     &     vyh,vzh,xht,yht,zht,vxht,vyht,vzht,rmin,rmax,rmaxu,
     &     qmin,lclose,rplsq,istat,rstat,outfile)
...
c...  Executable code 
     ...
     &       vxbt,vybt,vzbt,rmin,rmax,rmaxu,istat,rstat)
      ...
      if(qmin.ge.0.0) then
         call discard_peri_new(time,ntp,xht,yht,zht,vxht,vyht,vzht,
     &        qmin,istat,rstat,nbod,mass,xh,yh,zh,vxh,vyh,vzh,outfile)
      endif
