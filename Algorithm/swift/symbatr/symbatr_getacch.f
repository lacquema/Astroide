...
c     with mass < mtiny
c     Note: Since self-gravity among bodies of m<mtiny
c     is not handled in the Symba part of the code, there
c     can be no (symba) encounters between m<mtiny bodies.

      subroutine symbatr_getacch(nbod,nbodm,mass,j2rp2,
...
c      print *,'Calling symbatr_interface'
      call symbatr_interface(xh,yh,zh,axh,ayh,azh,
     &     mass,nbod,nbodm)
c      print *,'Returned from symbatr_interface'
