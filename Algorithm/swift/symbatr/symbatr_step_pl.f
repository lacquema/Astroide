...
c Last revision: 
      ...
      subroutine symbatr_step_pl(i1st,time,nbod,nbodm,mass,j2rp2,
...
c...  check for encounters
      ...
      do j=2,nbodm
         do i=j+1,nbod
            ieflg = 0
            call symbatr_chk(rhill,nbod,i,j,mass,xh,yh,zh,vxh,
...
c...  do a step
      if(isenc.eq.0) then
         call symbatr_step_helio(i1st,nbod,nbodm,mass,j2rp2,
     &     j4rp4,xh,yh,zh,vxh,vyh,vzh,dt)
         mergecnt=0
      else
         call symbatr_step_interp(time,iecnt,ielev,nbod,
