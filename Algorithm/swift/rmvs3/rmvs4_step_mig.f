...
c
      ...
      subroutine rmvs4_step_mig(i1st,time,nbod,ntp,mass,j2rp2,j4rp4,
     &     xh,yh,zh,vxh,vyh,vzh,xht,yht,zht,vxht,vyht,vzht,
     &     istat,rstat,dt,masst,enConstant,hConstant)
...
c...  Internals
      ...
      real*8 masst,ke,pot,energy,Envartot,Hvartot
      real*8 eltot(3)
...
c...  Executable code 
      ...
      call anal_energy_tp(nbod,mass,istat,j2rp2,j4rp4,xh,yh,zh,
     &           vxh,vyh,vzh,ntp,masst,xht,yht,zht,vxht,vyht,vzht,ke,
     &           pot,energy,eltot)


       if(time.ne.0.0) then
       Envartot = (energy - enConstant) 
       Hvartot=(sqrt(eltot(1)**2+eltot(2)**2+eltot(3)**2)-hConstant)
     &         
       endif
