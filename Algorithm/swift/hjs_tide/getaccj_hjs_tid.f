...
c...  Internals:
      ...
      real*8 vdotr,rx,ry,vx,vy,vz,cu,su,ff
      real*8, parameter :: 
...
c.....
            ...
            fz = 0.d0
c            print*,'1, (Omega.r)^2',sngl(fx),sngl(fy),sngl(fz)
c            if (e.gt.0.9999) print*,e,hh1,hh2
            fx = fx  - rot2*hh1*f2
c            print*,'1,Omega^2',-rot2*hh1*f2
            fx = fx - 12.d0*mu(k)*hh2*f2/q3
c            print*,'1,12', - 12.d0*mu(k)*hh2*f2/q3
            ff = 2.d0*r1(1)*hh1*f2
            fx = fx - ff*r1(1)
            fy = fy - ff*r2(1)
            fz = fz - ff*r3(1)
c            print*,'1,OMgea.r',sngl(-ff*r1(1)),sngl(-ff*r2(1)),
c     &                         sngl(-ff*r3(1))
...
c.....
            ...
            fz = 0.d0
c            print*,'2, (Omega.r)^2',sngl(fx),sngl(fy),sngl(fz)
            fx = fx  - rot2*hh1*f2
c            print*,'2,Omega^2',-rot2*hh1*f2
            fx = fx - 12.d0*eta(k)*hh2*f2/q3
c            print*,'2,12', - 12.d0*eta(k)*hh2*f2/q3
            ff = 2.d0*r1(2)*hh1*f2
            fx = fx - ff*r1(2)
            fy = fy - ff*r2(2)
            fz = fz - ff*r3(2)
c            print*,'2,OMgea.r',sngl(-ff*r1(2)),sngl(-ff*r2(2)),
c     &                         sngl(-ff*r3(2))
...
c            print*,sngl(sqrt(fqdx(1)**2+fqdy(1)**2+fqdz(1)**2)),
c     &            sngl(sqrt(fqdx(2)**2+fqdy(2)**2+fqdz(2)**2)),
c     &            sngl(sqrt(ftfx(1)**2+ftfy(1)**2+ftfz(1)**2)),
c     &            sngl(sqrt(ftfx(2)**2+ftfy(2)**2+ftfz(2)**2)),
c     &            sngl(sqrt(frelx**2+frely**2+frelz**2))
c            stop
