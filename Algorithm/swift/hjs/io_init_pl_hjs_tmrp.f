c************************************************************************
c                              IO_INIT_PL_HJS_TMRP.F
c************************************************************************
c IO_INIT_PL_HJS_TMRP reads in the data for the massive bodies for HJS 
c  + the coefs for the Poincare time transformation
...
c Date:    Sep 27, 2006
	...
	subroutine io_init_pl_hjs_tmrp(infile,lclose,iflgchk,nbod,oloc,
...
c...    Output
	...
	real*8 vxj(NPLMAX),vyj(NPLMAX),vzj(NPLMAX)
        real*8 eta(NPLMAX),mu(NPLMAX),coef(NPLMAX)
