...
c                 eoff          ==>  Energy offset (real scalar)
c Remarks: Based on symba5_step_interp
c Authors:  Hal Levison 
c Date:    2/3/2k
c Last revision: 

      subroutine symba5q_step_interp(time,iecnt,ielev,nbod,nbodm,
     &     mass,rhill,j2rp2,j4rp4,lclose,rpl,xh,yh,zh,vxh,vyh,vzh,
     &     dt,mergelst,mergecnt,eoff,ielc,ielst,mtiny,rtrans)
...
c..   Do a recursion step for full dt
      ...
      enddo
      mergecnt = 0
      call symba5q_step_recur(time,nbod,nbodm,mass,irec,ilevl,
     &     iecnt,ielev,rhill,xh,yh,zh,vxb,vyb,vzb,lclose,
     &     rpl,mergelst,mergecnt,dt,eoff,svdotr,ielc,ielst,rtrans)
