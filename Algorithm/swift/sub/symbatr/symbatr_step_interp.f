...
c Last revision: 5/13/99
      ...
      subroutine symbatr_step_interp(time,iecnt,ielev,nbod,
...
c...     only include those guys that it is not encountering with. 
      accnum = 1
      call symbatr_getacch(nbod,nbodm,mass,j2rp2,j4rp4,
...
c..   Do a recursion step for full dt
      irec = -1
      call symbatr_helio_drift(nbod,ielev,irec,mass,xh,
     &     yh,zh,vxb,vyb,vzb,dt)
      ...
      enddo
      mergecnt = 0
      call symbatr_step_recur(time,nbod,nbodm,mass,irec,ilevl,
