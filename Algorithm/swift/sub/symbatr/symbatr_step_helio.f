...
c Last revision: 
      ...
      subroutine symbatr_step_helio(i1st,nbod,nbodm,mass,j2rp2,
...
c...  Get the accelerations in helio frame. if frist time step
      accnum = 1
      call symbatr_helio_getacch(nbod,nbodm,mass,j2rp2,j4rp4,
