...
c Last revision: 
      ...
      subroutine symba6_step_helio(i1st,nbod,nbodm,mass,j2rp2,
...
c      i1stloc = 0
      call symba6_helio_getacch(i1stloc,nbod,nbodm,mass,j2rp2,j4rp4,
