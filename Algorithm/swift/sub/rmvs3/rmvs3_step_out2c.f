c*************************************************************************
c                            RMVS3_STEP_OUT2C.F (DKD steps)
c*************************************************************************
...
c
c Remarks: 
c Authors:  Hal Levison / H Beust
c Date:    Feb 1à, 2023
c Last revision: 

      subroutine rmvs3_step_out2c(i1st,nbod,ntp,mass,j2rp2,j4rp4,
...
c.... if not just do a normal step and leave
      if(icflg.eq.0) then
          ...
          call step_dkd_tp(i1st,nbod,ntp,mass,j2rp2,j4rp4,
