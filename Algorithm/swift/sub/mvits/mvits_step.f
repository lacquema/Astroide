...
c...  Now do the planets
     ...
     &     xh,yh,zh,vxh,vyh,vzh,dtpl)
      ...
      if(icall.gt.0) then
         call mvits_obl_kick(i1st,nbod,ntp,mass,j2rp2,j4rp4,xh,yh,zh,
     &     xht,yht,zht,vxht,vyht,vzht,istat,dth)
     ...
     &        idpl,xht,yht,zht,vxht,vyht,vzht,istat,dt,axht,ayht,azht)
         idum = 0
         call mvits_obl_kick(idum,nbod,ntp,mass,j2rp2,j4rp4,xh,
     &     yh,zh,xht,yht,zht,vxht,vyht,vzht,istat,dth)
      else
         call mvits_obl_kick(i1st,nbod,ntp,mass,j2rp2,j4rp4,xh,yh,zh,
     &     xht,yht,zht,vxht,vyht,vzht,istat,dth)
     ...
     &        idpl,xht,yht,zht,vxht,vyht,vzht,istat,dt,axht,ayht,azht)
         idum = 0
         call mvits_obl_kick(idum,nbod,ntp,mass,j2rp2,j4rp4,xh,yh,zh,
     &     xht,yht,zht,vxht,vyht,vzht,istat,dth)
      endif
