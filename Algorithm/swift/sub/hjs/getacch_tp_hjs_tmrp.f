...
c*************************************************************************
c This subroutine calculates the Jacobi acceleration on ONE TP
c in the HJS case , with Poincare time regularization
...
c                 axjt,ayjt,azjt ==> tp accel. in Jac. coord (real arrays)
c
c Author:  H. Beust  
c Date:    Sep. 25, 2006
c Remarks : Adapted from getacch_tp_hjs.f
     ...
     &     xjt,yjt,zjt,axbt,aybt,azbt,axjt,ayjt,azjt)
...
c...  Outputs:
      real*8 axbt,aybt,azbt,axjt,ayjt,azjt
