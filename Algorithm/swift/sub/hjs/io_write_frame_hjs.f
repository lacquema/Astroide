c*************************************************************************
c                            IO_WRITE_FRAME_HJS
c*************************************************************************
c write out a whole frame to an integer*2 binary file.
...
c
c
c Remarks: Adapted from io_write_frame.f
c Authors:  Herve Beust 
c Date:    Feb 12, 2002

      subroutine io_write_frame_hjs(time,nbod,ntp,oloc,matp,umat,
