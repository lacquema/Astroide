...
c
      ...
      subroutine step_kdk_mig_par_tp(i1st,nbod,ntp,mass,j2rp2,j4rp4,
...
c...      Get the accelerations in helio frame.
          call getacch_par_tp(nbod,ntp,mass,j2rp2,j4rp4,xbeg,ybeg,zbeg,
     &                  xht,yht,zht,istat,axht,ayht,azht)
          i1st = 1    ! turn this off
      endif

c...  Apply a heliocentric kick for a half dt 
      call kickvh_par_tp(ntp,vxht,vyht,vzht,axht,ayht,azht,istat,dth) 

c...  Take a drift forward full step
      call drift_mig_par_tp(ntp,mass(1),xht,yht,zht,vxht,vyht,vzht,dt,
     &             istat)	

c...  Get the accelerations in helio frame.
      call getacch_par_tp(nbod,ntp,mass,j2rp2,j4rp4,xend,yend,zend,
     &                  xht,yht,zht,istat,axht,ayht,azht)
